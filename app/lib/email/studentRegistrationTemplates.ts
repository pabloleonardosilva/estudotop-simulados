            ...
            <tr>
              <td style="padding:22px 34px;">
                <div style="background:linear-gradient(135deg,rgba(247,199,107,0.13),rgba(49,130,206,0.08));border:1px solid rgba(247,199,107,0.25);border-radius:18px;padding:22px;">
                  <p style="font-size:14px;color:#f7c76b;font-weight:700;margin:0 0 12px;letter-spacing:1px;text-transform:uppercase;">Dados de acesso</p>
                  <p style="font-size:15px;line-height:1.7;color:#d9e2f1;margin:0;">
                    <strong style="color:#ffffff;">Login:</strong> ${email}<br />
                    <strong style="color:#ffffff;">Senha provisória:</strong> ${temporaryPassword}
                  </p>
                </div>
              </td>
            </tr>
