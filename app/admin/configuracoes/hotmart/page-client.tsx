...
export default function HotmartPageClient({ jornadas, events }: { jornadas: Destination[]; events: Destination[] }) {
  ...
  async function lookupProduct() {
    ...
    const response = await adminFetch(`/api/admin/hotmart/products/lookup?ucode=${encodeURIComponent(ucode)}`);
  ...
  function fillProductionProduct(product: { name: string; ucode: string }) {
