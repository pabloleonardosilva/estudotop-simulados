    ...
    <PageBackground variant="jornada">
      ...
      <section className="et-admin-dark-hero mb-8 min-h-[190px] px-6 py-8 sm:px-8 lg:px-10">
        <div className="relative flex min-h-[126px] items-center justify-between gap-8">
          <div>
            ...
            <h1 className="et-admin-dark-page-title mt-3">Disciplinas</h1>
            <p className="et-admin-dark-text mt-4 max-w-2xl">Organize o banco de questões por disciplinas. Cada disciplina poderá receber vários assuntos.</p>
          </div>
          <div className="et-admin-dark-icon-box et-admin-dark-icon-box-orange hidden !h-20 !w-20 !rounded-[1.5rem] sm:flex"><BookOpen size={34} strokeWidth={1.7} /></div>
        </div>
      </section>
      ...
      <div className="grid items-start gap-6 lg:grid-cols-[minmax(280px,30%)_minmax(0,70%)]">
        <section className="et-admin-dark-panel p-5 sm:p-7">
          <div className="mb-7 flex items-start gap-4"><div className="et-admin-dark-icon-box et-admin-dark-icon-box-orange"><Plus size={20} strokeWidth={2.4} /></div><div><h2 className="et-admin-dark-section-title">Nova disciplina</h2><p className="et-admin-dark-muted mt-1.5">Cadastre disciplinas com nome padronizado.</p></div></div>
        ...
        <section className="et-admin-dark-panel min-w-0 p-5 sm:p-7">
          <div className="mb-7 flex items-start gap-4"><div className="et-admin-dark-icon-box et-admin-dark-icon-box-orange"><BookOpen size={20} strokeWidth={2.2} /></div><div><h2 className="et-admin-dark-section-title">Disciplinas cadastradas</h2><p className="et-admin-dark-muted mt-1.5">Toque ou clique no card para expandir.</p></div></div>
          <div className="et-admin-dark-card mb-6 p-4">
            <PremiumInput
          variant="jornada"
              label="Buscar"
              icon={<Search size={16} />}
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              {filtered.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className={`et-admin-dark-list-card overflow-hidden transition hover:-translate-y-0.5 hover:border-white/[0.12] ${item.is_active ? "" : "opacity-70"}`}
                  >
                    <button
                      type="button"
                    ...
                    >
                      <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-2">
                          <p className="et-admin-dark-card-title truncate text-base">
                            {item.name}
                          </p>

                          <span
                            className={`et-admin-dark-badge ${item.is_active ? "et-admin-dark-badge-success" : "et-admin-dark-badge-neutral"}`}
                          >
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                          <span className="et-admin-dark-badge et-admin-dark-badge-neutral">
                            {subjectCount} {subjectCount === 1 ? "assunto" : "assuntos"}
                          </span>
                          <span className="et-admin-dark-badge et-admin-dark-badge-warning">
          ...
          variant="jornada"
                            ...
                            <div className="grid gap-2">
                              <PremiumButton variant="dark-primary" onClick={() => saveEdit(item.id)} full disabled={saving}>
                                Salvar alterações
                              </PremiumButton>
