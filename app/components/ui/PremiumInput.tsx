      ...
      {textarea ? (
        ...
        <div className="relative">
          <input
            {...props}
            onChange={handleChange}
            className={`${dark ? "et-admin-dark-input h-12 w-full px-4 pr-12 text-sm outline-none transition placeholder:text-slate-600 focus:border-orange-400/50 focus:ring-4 focus:ring-orange-500/10" : "et-clean-field h-12 w-full rounded-2xl border border-slate-200 bg-white px-4 pr-12 text-sm text-slate-700 outline-none transition placeholder:text-slate-400 focus:border-orange-400 focus:ring-4 focus:ring-orange-100"} [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none ${className}`}
          />
        ...
        <input
          {...props}
          onChange={handleChange}
          className={`${dark ? "et-admin-dark-input h-12 w-full px-4 text-sm outline-none transition placeholder:text-slate-600 focus:border-orange-400/50 focus:ring-4 focus:ring-orange-500/10" : "et-clean-field h-12 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 outline-none transition placeholder:text-slate-400 focus:border-orange-400 focus:ring-4 focus:ring-orange-100"} ${className}`}
        />
      )}
    </div>
  );
